...
var vJSONDB =  {
  ...
  "DBmandatory": [false,false,true,true,true,true,true,true,false,false],
  "DBvisible": [false,false,true,true,true,true,true,true,false,false],
  "DBcolinput": {
     ...
     "countapprox1": "<SELECT name=\"countapprox1\" size=\"1\"><OPTION></OPTION><OPTION value='0.0'>None </OPTION><OPTION value='0.33333'>Very few (1-2)</OPTION><OPTION value='0.666666'>Some (3-10)</OPTION><OPTION value='1.0'>High  (more than 10)</OPTION><OPTION value='NA'>Don`t know</OPTION></SELECT>",
     "yesnodontknow1": "<select name=\"yesnodontknow1\" size=\"1\"><OPTION></OPTION><option value='1.0'>Yes</option><option value='0.0'>No</option><option value='NA'>don`t know</option></select> <p align='center'><br><img width='90%' src='images/aedes_albopictus.jpg'></p>",
     "countapprox2": "<SELECT name=\"countapprox2\" size=\"1\"><OPTION></OPTION><OPTION value='0.0'>None </OPTION><OPTION value='0.33333'>Very few (1-2)</OPTION><OPTIONv alue='0.666666'>Some (3-10)</OPTION><OPTION value='1.0'>High  (more than 10)</OPTION><OPTION value='NA'>Don`t know</OPTION></SELECT>",
     "peopleapproxii": "<SELECT name=\"peopleapproxii\" size=\"1\"><OPTION></OPTION><OPTION value='0.0'>No one </OPTION><OPTION value='0.33333'>1</OPTION><OPTION value='0.666666'>2</OPTION><OPTION value='1.0'>more than 2</OPTION><OPTION value='NA'>Don`t know</OPTION></SELECT>",
     "countapprox3": "<SELECT name=\"countapprox3\" size=\"1\"><OPTION></OPTION><OPTION value='0.0'>None </OPTION><OPTION value='0.25'>Very few (1-2)</OPTION value='0.5'><OPTION value='0.75'>Some (3-10)</OPTION><OPTION value='1.0'>High  (more than 10)</OPTION><OPTION value='NA'>Don`t know</OPTION></SELECT>",
